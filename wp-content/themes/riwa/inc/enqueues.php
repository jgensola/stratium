...
function riwa_scripts() {
	...
	wp_enqueue_style( 'riwa-sidepanel', get_template_directory_uri() . '/css/side-panel.css', array(), '1.0.0' );
	wp_enqueue_style( 'riwa-sidebar-menu', get_template_directory_uri() . '/css/sidebar-menu.css', array(), '1.0.0' );
	wp_enqueue_style( 'animate-css', get_template_directory_uri() . '/css/animate.min.css', array(), '1.0.0' );
	wp_enqueue_style( 'riwa-css', get_template_directory_uri() . '/css/riwa.css', array(), '1.0' );
	...
	wp_enqueue_script( 'fancybox-media', get_template_directory_uri() . '/js/jquery.fancybox-media.js', array(), '1.0.6', true );
	wp_enqueue_script( 'riwa-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20160412', true );
	...
	wp_enqueue_script( 'riwa-countTo', get_template_directory_uri() . '/js/countTo.js', array('jquery'), '0.1', true );
	wp_enqueue_script( 'riwa-appear', get_template_directory_uri() . '/js/jquery.appear.js', array('jquery'), '0.1', true );
	...
	wp_enqueue_script( 'riwa-dlmenu', get_template_directory_uri() . '/js/jquery.dlmenu.js', array('jquery'), '1.0.0', true );
	wp_enqueue_script( 'riwa-res-tab', get_template_directory_uri() . '/js/jquery.responsiveTabs.min.js', array('jquery'), '1.6.1', true );
	wp_enqueue_script( 'riwa-functions-theme', get_template_directory_uri() . '/js/functions.js', array('jquery'), '1.0', true );
