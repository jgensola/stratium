...
/* Medical Icons */
if(!( function_exists('ti_get_icons') )){
	function ti_get_icons(){
		$icons = array(
			'none',
			'icon-lungs', 
			'icon-ambulanc', 
			'icon-first-aid-box', 
			'icon-ambulance-siren',
			'icon-tooth',
			'icon-add-tooth', 
			'icon-remove-tooth', 
			'icon-aids-symbol', 
			...
			'icon-tablet6', 
			'icon-first-aid-box2',
			'icon-prescription-pad', 
			'icon-Medicine-bottle', 
			'icon-tablets', 
			'icon-air-ambulance-helicopter',
			'arrow_back', 
		);
		return $icons;	
	}
...
/* Fa Icons */
if(!( function_exists('ti_get_icons_fa') )){
	function ti_get_icons_fa() {
		$this->icons = array(
			'fa-500px' => '\f26e',
			'fa-adjust' => '\f042',
			'fa-adn' => '\f170',
